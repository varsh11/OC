...
public abstract class Result {
    ...
    private void launchAddToFavorites(Context context, Pojo app) {
        ...
        OCApplication.getDataHandler(context).addToFavorites((MainActivity) context, app.id);
    ...
    void recordLaunch(Context context) {
        // Save in history
        OCApplication.getDataHandler(context).addToHistory(pojo.id);
    }
