package fr.neamar.ocmaster.result;
...
import fr.neamar.ocmaster.pojo.AppPojo;
...
public class AppResult extends Result {
    ...
    protected PopupMenu buildPopupMenu(Context context, final RecordAdapter parent, View parentView) {
        ...
        if (OCApplication.getRootHandler(context).isRootActivated() && OCApplication.getRootHandler(context).isRootAvailable()) {
    ...
    private void excludeFromAppList(Context context, AppPojo appPojo) {
        ...
        OCApplication.getDataHandler(context).getAppProvider().removeApp(appPojo);
        OCApplication.getDataHandler(context).removeFromFavorites(appPojo, context);
    ...
    private void hibernate(Context context, AppPojo app) {
        ...
        if (!OCApplication.getRootHandler(context).hibernateApp(appPojo.packageName)) {
    ...
    public Drawable getDrawable(Context context) {
        ...
        if (icon == null) {
             icon = OCApplication.getIconsHandler(context).getDrawableIconForPackage(className);
        }
