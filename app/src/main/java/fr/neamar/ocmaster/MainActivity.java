...
import fr.neamar.ocmaster.adapter.RecordAdapter;
import fr.neamar.ocmaster.broadcast.IncomingCallHandler;
import fr.neamar.ocmaster.broadcast.IncomingSmsHandler;
...
import fr.neamar.ocmaster.searcher.ApplicationsSearcher;
import fr.neamar.ocmaster.searcher.HistorySearcher;
import fr.neamar.ocmaster.searcher.NullSearcher;
import fr.neamar.ocmaster.searcher.QueryInterface;
import fr.neamar.ocmaster.searcher.QuerySearcher;
import fr.neamar.ocmaster.searcher.Searcher;
import fr.neamar.ocmaster.ui.BlockableListView;
import fr.neamar.ocmaster.ui.BottomPullEffectView;
import fr.neamar.ocmaster.ui.KeyboardScrollHider;
import fr.neamar.ocmaster.utils.PackageManagerUtils;
...
public class MainActivity extends Activity implements QueryInterface, KeyboardScrollHider.KeyboardHandler {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        OCApplication.initDataHandler(this);
        ...
        resultText  = (TextView) findViewById(R.id.searchEditText);
    ...
    protected void onResume() {
        ...
        AppProvider appProvider = OCApplication.getDataHandler(this).getAppProvider();
    ...
    protected void onDestroy() {
        ...
        OCApplication.getCameraHandler().releaseCamera();
    }
    ...
    public void onFavoriteButtonClicked(View favorite) {
        ...
        // Favorites handling
        Pojo pojo = OCApplication.getDataHandler(MainActivity.this).getFavorites(tryToRetrieve)
    ...
    public void retrieveFavorites() {
        ArrayList<Pojo> favoritesPojo = OCApplication.getDataHandler(MainActivity.this)
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://fr.neamar.kiss/http/host/path")
        );
