package fr.neamar.ocmaster.toggles;
...
public class TogglesHandler {
    ...
    private Boolean getTorchState() {
        return OCApplication.getCameraHandler().isTorchAvailable() && OCApplication.getCameraHandler().getTorchState();
    }

    private void setTorchState(Boolean state) {
        if(OCApplication.getCameraHandler().isTorchAvailable()) {
            OCApplication.getCameraHandler().setTorchState(state);
        }
    }
